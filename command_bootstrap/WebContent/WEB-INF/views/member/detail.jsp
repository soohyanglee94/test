	        	...
	        	<div class="register-card-body" >
	                ...
	                <div class="form-group row">
	                 ...
	                 <div class="form-group row">
	                  ...
	                  <div class="col-sm-9">   
	                  	<input name="phone" type="text" class="form-control" id="inputPassword3" value="${member.email }" readonly>	                
	                  </div>                  
	                </div>               
	              </div>  
		          <div class="card-footer" >
		          		<div class="row">
			          		...
			          		<div class="col-sm-<%-- ${loginUser.id eq member.id ? '3':'12'} --%>3text-center">
